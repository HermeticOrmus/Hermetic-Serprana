        ...
        <div className="max-w-5xl mx-auto space-y-16">
          {offerings.map((offering, index) => (
            ...
            >
              ...
              <p className="text-earth-600 font-medium mb-6">{offering.type}</p>

              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-earth-800 mb-2">What it is:</h3>
                  <p className="text-earth-700 leading-relaxed">{offering.description}</p>
                </div>

                <div>
                  <h3 className="font-semibold text-earth-800 mb-2">Who it's for:</h3>
