    ...
    <div className="bg-sage-900">
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-sage-800 to-sage-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-sage-200 leading-relaxed italic">
      ...
      {/* Important Notice */}
      <section className="py-12 px-4 bg-sage-800">
        <div className="max-w-3xl mx-auto">
          <div className="bg-sage-700 border-2 border-sage-600 rounded-lg p-8 text-center">
            <h2 className="text-2xl md:text-3xl font-display mb-4 text-sage-100">
      ...
      <section className="py-16 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-display text-center mb-12 text-sage-100">
            Available Services
          </h2>
      ...
      <section className="py-20 px-4 bg-sage-900 border-t border-sage-700">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-display text-center mb-4 text-sage-100">
            Book Your Session
          </h2>
          <p className="text-center text-sage-200 mb-12 italic">
      ...
      <section className="py-12 px-4 bg-sage-800">
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-2xl font-display mb-4 text-sage-100">Payment Methods</h3>
