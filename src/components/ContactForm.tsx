    ...
    <>
      ...
      <div className="mt-8 text-center">
        ...
        <a
          ...
          className="inline-flex items-center px-6 py-3 bg-sage-600 text-sage-50 rounded-md hover:bg-sage-500 transition-colors font-medium shadow-md hover:shadow-lg"
        >
